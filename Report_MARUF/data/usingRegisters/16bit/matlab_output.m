...
fileID1 = fopen('IP16_FinalData_cos.txt','r');
fileID2 = fopen('IP16_FinalData_sin.txt','r');
formatSpec = '%f';
...
fileID1 = fopen('BR16_FinalData_cos.txt','r');
fileID2 = fopen('BR16_FinalData_sin.txt','r');
formatSpec = '%f';
...
fileID1 = fopen('D16_FinalData_cos.txt','r');
fileID2 = fopen('D16_FinalData_sin.txt','r');
formatSpec = '%f';
...
subplot(2,2,2), plot(theta,COS_FPGA_BR8), hold on, plot(theta,SIN_FPGA_BR8) ,xlabel('Theta'),ylabel('Amplitude'),title('FPGA output: 16-bit Block-RAM Simulink');
subplot(2,2,3), plot(theta,COS_FPGA_IP8), hold on, plot(theta,SIN_FPGA_IP8) ,xlabel('Theta'),ylabel('Amplitude'),title('FPGA output: 16-bit CORDIC IP Simulink');
subplot(2,2,4), plot(theta,COS_FPGA_D8), hold on, plot(theta,SIN_FPGA_D8) ,xlabel('Theta'),ylabel('Amplitude'),title('FPGA output: 16-bit Direct VHDL in Vivado');
...
subplot(1,3,1), plot(theta, cos_abs_diff_BR8), xlabel('Theta'),ylabel('Amplitude'),title('FPGA output: 16-bit Block-RAM Simulink');
subplot(1,3,2), plot(theta, cos_abs_diff_IP8) ,xlabel('Theta'),ylabel('Amplitude'),title('FPGA output: 16-bit CORDIC IP Simulink');
subplot(1,3,3), plot(theta, cos_abs_diff_D8) ,xlabel('Theta'),ylabel('Amplitude'),title('FPGA output: 16-bit Direct VHDL in Vivado');
