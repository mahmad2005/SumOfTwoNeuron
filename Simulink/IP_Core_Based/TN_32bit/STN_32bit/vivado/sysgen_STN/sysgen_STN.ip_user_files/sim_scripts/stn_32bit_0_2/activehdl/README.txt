...
#
# Generated by export_simulation on Sun Dec 25 23:44:07 -0600 2022
#
################################################################################
...
'-reset_run' switch to the './stn_32bit_0.sh' script.

./stn_32bit_0.sh -reset_run
...
./stn_32bit_0.sh -noclean_files

For more information on the script, please type './stn_32bit_0.sh -help'.
