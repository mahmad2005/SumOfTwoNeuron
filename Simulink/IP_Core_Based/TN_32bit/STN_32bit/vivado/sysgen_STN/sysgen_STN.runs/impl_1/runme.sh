...
HD_PWD='E:/FPGAProject/01102022/FPGAResearch/5_Final_Submission/Simulink/IP_Core_Based/TN_32bit/STN_32bit/vivado/sysgen_STN/sysgen_STN.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sysgen_STN.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sysgen_STN.tcl -notrace
