...
HD_PWD='E:/FPGAProject/01102022/FPGAResearch/5_Final_Submission/Simulink/IP_Core_Based/TN_32bit/STN_32bit/vivado/sysgen_STN/sysgen_STN.runs/stn_32bit_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stn_32bit_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stn_32bit_0.tcl
