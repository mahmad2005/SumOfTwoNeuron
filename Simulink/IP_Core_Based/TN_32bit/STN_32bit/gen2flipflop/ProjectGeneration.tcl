...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{vivado_ip.tcl}}
		{{stn_32bit_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{stn_32bit.vhd} -lib {xil_defaultlib}}
		{{stn_32bit_clock.xdc}}
		{{stn_32bit.xdc}}
	}
	set SimPeriod 1
	...
	set TargetDir {E:/FPGAProject/01102022/FPGAResearch/5_Final_Submission/Simulink/IP_Core_Based/TN_32bit/STN_32bit/gen2flipflop}
	set TopLevelModule {stn_32bit}
	...
	dict set TopLevelPortInterface input_t DatFile {stn_32bit_cordic_ip_based_sumoftwoneurons_input_t.dat}
	...
	dict set TopLevelPortInterface input_t ClockDomain {stn_32bit}
	...
	dict set TopLevelPortInterface out_imag DatFile {stn_32bit_cordic_ip_based_sumoftwoneurons_out_imag.dat}
	...
	dict set TopLevelPortInterface out_imag ClockDomain {stn_32bit}
	...
	dict set TopLevelPortInterface out_real DatFile {stn_32bit_cordic_ip_based_sumoftwoneurons_out_real.dat}
	...
	dict set TopLevelPortInterface out_real ClockDomain {stn_32bit}
	...
	dict set TopLevelPortInterface clk ClockDomain {stn_32bit}
