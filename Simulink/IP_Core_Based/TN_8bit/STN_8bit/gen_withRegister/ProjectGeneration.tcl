...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{vivado_ip.tcl}}
		{{stn_8bit_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{stn_8bit.vhd} -lib {xil_defaultlib}}
		{{stn_8bit_clock.xdc}}
		{{stn_8bit.xdc}}
	}
	set SimPeriod 1
	set SimTime 7400
	set SimulationTime {740300.00000000 ns}
	set SynthStrategyName {Vivado Synthesis Defaults}
	set SynthesisTool {Vivado}
	set TargetDir {E:/FPGAProject/01102022/FPGAResearch/5_Final_Submission/Simulink/IP_Core_Based/TN_8bit/STN_8bit/gen_withRegister}
	set TopLevelModule {stn_8bit}
	...
	dict set TopLevelPortInterface input_t DatFile {stn_8bit_subsystem_input_t.dat}
	...
	dict set TopLevelPortInterface input_t ClockDomain {stn_8bit}
	...
	dict set TopLevelPortInterface out_imag Type Fix_8_5
	dict set TopLevelPortInterface out_imag ArithmeticType xlSigned
	dict set TopLevelPortInterface out_imag BinaryPoint 5
	dict set TopLevelPortInterface out_imag Width 8
	dict set TopLevelPortInterface out_imag DatFile {stn_8bit_subsystem_out_imag.dat}
	...
	dict set TopLevelPortInterface out_imag ClockDomain {stn_8bit}
	...
	dict set TopLevelPortInterface out_real Type Fix_8_5
	dict set TopLevelPortInterface out_real ArithmeticType xlSigned
	dict set TopLevelPortInterface out_real BinaryPoint 5
	dict set TopLevelPortInterface out_real Width 8
	dict set TopLevelPortInterface out_real DatFile {stn_8bit_subsystem_out_real.dat}
	...
	dict set TopLevelPortInterface out_real ClockDomain {stn_8bit}
	...
	dict set TopLevelPortInterface clk ClockDomain {stn_8bit}
