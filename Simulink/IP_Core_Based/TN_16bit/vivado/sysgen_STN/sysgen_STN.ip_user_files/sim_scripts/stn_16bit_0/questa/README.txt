...
#
# Generated by export_simulation on Tue Nov 22 22:39:27 -0600 2022
#
################################################################################
...
'-reset_run' switch to the './stn_16bit_0.sh' script.

./stn_16bit_0.sh -reset_run
...
./stn_16bit_0.sh -noclean_files

For more information on the script, please type './stn_16bit_0.sh -help'.
