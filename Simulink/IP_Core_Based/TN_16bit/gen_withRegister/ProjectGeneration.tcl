...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{vivado_ip.tcl}}
		{{stn_16bit_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{stn_16bit.vhd} -lib {xil_defaultlib}}
		{{stn_16bit_clock.xdc}}
		{{stn_16bit.xdc}}
	}
	set SimPeriod 1
	...
	set TargetDir {E:/FPGAProject/01102022/FPGAResearch/5_Final_Submission/Simulink/IP_Core_Based/TN_16bit/gen_withRegister}
	set TopLevelModule {stn_16bit}
	...
	dict set TopLevelPortInterface input_t DatFile {stn_16bit_subsystem_input_t.dat}
	...
	dict set TopLevelPortInterface input_t ClockDomain {stn_16bit}
	...
	dict set TopLevelPortInterface out_imag DatFile {stn_16bit_subsystem_out_imag.dat}
	...
	dict set TopLevelPortInterface out_imag ClockDomain {stn_16bit}
	...
	dict set TopLevelPortInterface out_real DatFile {stn_16bit_subsystem_out_real.dat}
	...
	dict set TopLevelPortInterface out_real ClockDomain {stn_16bit}
	...
	dict set TopLevelPortInterface clk ClockDomain {stn_16bit}
