...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{vivado_ip.tcl}}
		{{xpm_107094_vivado.mem}}
		{{xpm_b071dd_vivado.mem}}
		{{bram_stn_64bit_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{bram_stn_64bit.vhd} -lib {xil_defaultlib}}
		{{bram_stn_64bit_clock.xdc}}
		{{bram_stn_64bit.xdc}}
	}
	set SimPeriod 1
	set SimTime 7500
	...
	set TargetDir {E:/FPGAProject/01102022/FPGAResearch/6_FinalExam/Vivado/SumofTwoNeuron_64bit/BRAM64bit/gen64}
	set TopLevelModule {bram_stn_64bit}
	set TopLevelSimulinkHandle 0.00146484
	set VHDLLib {xil_defaultlib}
	set TopLevelPortInterface {}
	dict set TopLevelPortInterface input_t Name {input_t}
	dict set TopLevelPortInterface input_t Type Fix_64_59
	dict set TopLevelPortInterface input_t ArithmeticType xlSigned
	dict set TopLevelPortInterface input_t BinaryPoint 59
	dict set TopLevelPortInterface input_t Width 64
	dict set TopLevelPortInterface input_t DatFile {bram_stn_64bit_bram_sumoftwoneurons_64bit_input_t.dat}
	...
	dict set TopLevelPortInterface input_t ClockDomain {bram_stn_64bit}
	...
	dict set TopLevelPortInterface out_imag Type Fix_64_59
	dict set TopLevelPortInterface out_imag ArithmeticType xlSigned
	dict set TopLevelPortInterface out_imag BinaryPoint 59
	dict set TopLevelPortInterface out_imag Width 64
	dict set TopLevelPortInterface out_imag DatFile {bram_stn_64bit_bram_sumoftwoneurons_64bit_out_imag.dat}
	...
	dict set TopLevelPortInterface out_imag ClockDomain {bram_stn_64bit}
	...
	dict set TopLevelPortInterface out_real Type Fix_64_59
	dict set TopLevelPortInterface out_real ArithmeticType xlSigned
	dict set TopLevelPortInterface out_real BinaryPoint 59
	dict set TopLevelPortInterface out_real Width 64
	dict set TopLevelPortInterface out_real DatFile {bram_stn_64bit_bram_sumoftwoneurons_64bit_out_real.dat}
	...
	dict set TopLevelPortInterface out_real ClockDomain {bram_stn_64bit}
	...
	dict set TopLevelPortInterface clk ClockDomain {bram_stn_64bit}
