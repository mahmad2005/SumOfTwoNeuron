...
HD_PWD='E:/FPGAProject/01102022/FPGAResearch/6_FinalExam/Vivado/SumofTwoNeuron_64bit/vivado/sysgen_STN/sysgen_STN.runs/bram_stn_64bit_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_stn_64bit_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_stn_64bit_0.tcl
