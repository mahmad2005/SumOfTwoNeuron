...
begin
  ...
  constant2 : entity xil_defaultlib.sysgen_constant_44fb0f4486 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  generic map (
    ...
    c_width => 16,
    latency => 1,
    mem_init_file => "xpm_161541_vivado.mem",
    mem_size => 32768,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 16,
    latency => 1,
    mem_init_file => "xpm_184d04_vivado.mem",
    mem_size => 32768,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  register3 : entity xil_defaultlib.bram_stn_16bit_xlregister 
  generic map (
    d_width => 11,
...
begin
  ...
  register6 : entity xil_defaultlib.bram_stn_16bit_xlregister 
  generic map (
    d_width => 16,
    init_value => b"0000000000000000"
  )
  ...
  register7 : entity xil_defaultlib.bram_stn_16bit_xlregister 
  generic map (
    d_width => 16,
    init_value => b"0000000000000000"
  )
  ...
  register8 : entity xil_defaultlib.bram_stn_16bit_xlregister 
  generic map (
    d_width => 16,
    init_value => b"0000000000000000"
  )
  ...
  register9 : entity xil_defaultlib.bram_stn_16bit_xlregister 
  generic map (
    d_width => 16,
    init_value => b"0000000000000000"
  )
  ...
  register10 : entity xil_defaultlib.bram_stn_16bit_xlregister 
  generic map (
    d_width => 16,
    init_value => b"0000000000000000"
  )
  ...
  register11 : entity xil_defaultlib.bram_stn_16bit_xlregister 
  generic map (
    d_width => 16,
    init_value => b"0000000000000000"
  )
  ...
  register12 : entity xil_defaultlib.bram_stn_16bit_xlregister 
  generic map (
    d_width => 16,
    init_value => b"0000000000000000"
  )
  ...
  register13 : entity xil_defaultlib.bram_stn_16bit_xlregister 
  generic map (
    d_width => 16,
    init_value => b"0000000000000000"
  )
  ...
  register14 : entity xil_defaultlib.bram_stn_16bit_xlregister 
  generic map (
    d_width => 16,
    init_value => b"0000000000000000"
  )
  ...
  register15 : entity xil_defaultlib.bram_stn_16bit_xlregister 
  generic map (
    d_width => 16,
    init_value => b"0000000000000000"
  )
  ...
  register16 : entity xil_defaultlib.bram_stn_16bit_xlregister 
  generic map (
    d_width => 16,
    init_value => b"0000000000000000"
  )
  ...
  register17 : entity xil_defaultlib.bram_stn_16bit_xlregister 
  generic map (
    d_width => 16,
    init_value => b"0000000000000000"
  )
