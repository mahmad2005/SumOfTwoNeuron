...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set TargetDir {E:/FPGAProject/01102022/FPGAResearch/5_Final_Submission/Simulink/BRAM_LT_Based/BRAM16bit/gen}
	set TopLevelModule {bram_stn_16bit}
	set TopLevelSimulinkHandle 962
