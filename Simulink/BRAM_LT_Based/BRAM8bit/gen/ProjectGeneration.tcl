...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{vivado_ip.tcl}}
		{{xpm_1efe91_vivado.mem}}
		{{xpm_9cb0bf_vivado.mem}}
		{{bram_stn_8bit_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{bram_stn_8bit.vhd} -lib {xil_defaultlib}}
		{{bram_stn_8bit_clock.xdc}}
		{{bram_stn_8bit.xdc}}
	}
	set SimPeriod 1
	set SimTime 7500
	...
	set TargetDir {E:/FPGAProject/01102022/FPGAResearch/5_Final_Submission/Simulink/BRAM_LT_Based/BRAM8bit/gen}
	set TopLevelModule {bram_stn_8bit}
	set TopLevelSimulinkHandle 0.00012207
	set VHDLLib {xil_defaultlib}
	set TopLevelPortInterface {}
	dict set TopLevelPortInterface input_t Name {input_t}
	dict set TopLevelPortInterface input_t Type Fix_8_3
	dict set TopLevelPortInterface input_t ArithmeticType xlSigned
	dict set TopLevelPortInterface input_t BinaryPoint 3
	dict set TopLevelPortInterface input_t Width 8
	dict set TopLevelPortInterface input_t DatFile {bram_stn_8bit_subsystem_input_t.dat}
	...
	dict set TopLevelPortInterface input_t ClockDomain {bram_stn_8bit}
	...
	dict set TopLevelPortInterface out_imag Type Fix_8_3
	dict set TopLevelPortInterface out_imag ArithmeticType xlSigned
	dict set TopLevelPortInterface out_imag BinaryPoint 3
	dict set TopLevelPortInterface out_imag Width 8
	dict set TopLevelPortInterface out_imag DatFile {bram_stn_8bit_subsystem_out_imag.dat}
	...
	dict set TopLevelPortInterface out_imag ClockDomain {bram_stn_8bit}
	...
	dict set TopLevelPortInterface out_real Type Fix_8_3
	dict set TopLevelPortInterface out_real ArithmeticType xlSigned
	dict set TopLevelPortInterface out_real BinaryPoint 3
	dict set TopLevelPortInterface out_real Width 8
	dict set TopLevelPortInterface out_real DatFile {bram_stn_8bit_subsystem_out_real.dat}
	...
	dict set TopLevelPortInterface out_real ClockDomain {bram_stn_8bit}
	...
	dict set TopLevelPortInterface clk ClockDomain {bram_stn_8bit}
