...
HD_PWD='E:/FPGAProject/01102022/FPGAResearch/5_Final_Submission/Simulink/BRAM_LT_Based/BRAM8bit/vivado/sysgen_STN/sysgen_STN.runs/bram_stn_8bit_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_stn_8bit_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_stn_8bit_0.tcl
