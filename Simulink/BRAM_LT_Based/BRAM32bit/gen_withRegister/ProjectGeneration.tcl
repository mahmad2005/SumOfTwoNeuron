...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{vivado_ip.tcl}}
		{{xpm_f35e4b_vivado.mem}}
		{{xpm_b9d794_vivado.mem}}
		{{bram_stn_32bit_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{bram_stn_32bit.vhd} -lib {xil_defaultlib}}
		{{bram_stn_32bit_clock.xdc}}
		{{bram_stn_32bit.xdc}}
	}
	set SimPeriod 1
	set SimTime 7500
	...
	set TargetDir {E:/FPGAProject/01102022/FPGAResearch/5_Final_Submission/Simulink/BRAM_LT_Based/BRAM32bit/gen_withRegister}
	set TopLevelModule {bram_stn_32bit}
	set TopLevelSimulinkHandle 0.000488281
	set VHDLLib {xil_defaultlib}
	set TopLevelPortInterface {}
	dict set TopLevelPortInterface input_t Name {input_t}
	dict set TopLevelPortInterface input_t Type Fix_32_27
	dict set TopLevelPortInterface input_t ArithmeticType xlSigned
	dict set TopLevelPortInterface input_t BinaryPoint 27
	dict set TopLevelPortInterface input_t Width 32
	dict set TopLevelPortInterface input_t DatFile {bram_stn_32bit_bram_sumoftwoneurons_32bit_input_t.dat}
	...
	dict set TopLevelPortInterface input_t ClockDomain {bram_stn_32bit}
	...
	dict set TopLevelPortInterface out_imag Type Fix_32_27
	dict set TopLevelPortInterface out_imag ArithmeticType xlSigned
	dict set TopLevelPortInterface out_imag BinaryPoint 27
	dict set TopLevelPortInterface out_imag Width 32
	dict set TopLevelPortInterface out_imag DatFile {bram_stn_32bit_bram_sumoftwoneurons_32bit_out_imag.dat}
	...
	dict set TopLevelPortInterface out_imag ClockDomain {bram_stn_32bit}
	...
	dict set TopLevelPortInterface out_real Type Fix_32_27
	dict set TopLevelPortInterface out_real ArithmeticType xlSigned
	dict set TopLevelPortInterface out_real BinaryPoint 27
	dict set TopLevelPortInterface out_real Width 32
	dict set TopLevelPortInterface out_real DatFile {bram_stn_32bit_bram_sumoftwoneurons_32bit_out_real.dat}
	...
	dict set TopLevelPortInterface out_real ClockDomain {bram_stn_32bit}
	...
	dict set TopLevelPortInterface clk ClockDomain {bram_stn_32bit}
