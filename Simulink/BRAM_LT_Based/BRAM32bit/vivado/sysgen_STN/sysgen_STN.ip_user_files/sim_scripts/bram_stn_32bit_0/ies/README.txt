...
#
# Generated by export_simulation on Tue Nov 22 21:28:08 -0600 2022
#
################################################################################
...
'-reset_run' switch to the './bram_stn_32bit_0.sh' script.

./bram_stn_32bit_0.sh -reset_run
...
./bram_stn_32bit_0.sh -noclean_files

For more information on the script, please type './bram_stn_32bit_0.sh -help'.
