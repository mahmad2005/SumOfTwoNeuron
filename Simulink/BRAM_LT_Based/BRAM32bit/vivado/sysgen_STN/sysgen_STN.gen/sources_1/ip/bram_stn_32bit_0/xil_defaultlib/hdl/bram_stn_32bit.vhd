-- Generated from Simulink block BRAM_STN_32bit/Subsystem/Subsystem/BRAM_CORDIC
library IEEE;
...
-- Generated from Simulink block BRAM_STN_32bit/Subsystem/Subsystem
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity bram_stn_32bit_subsystem_x0 is
  port (
    in1 : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end bram_stn_32bit_subsystem_x0;
architecture structural of bram_stn_32bit_subsystem_x0 is 
  signal imag_data_net : std_logic_vector( 32-1 downto 0 );
  signal addsub_s_net : std_logic_vector( 32-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
-- Generated from Simulink block BRAM_STN_32bit/Subsystem/Subsystem1/BRAM_CORDIC
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block BRAM_STN_32bit/Subsystem/Subsystem1
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block BRAM_STN_32bit/Subsystem
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  subsystem : entity xil_defaultlib.bram_stn_32bit_subsystem_x0 
  port map (
    in1 => addsub_s_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
