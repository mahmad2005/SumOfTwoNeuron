...
begin
  input_t_net <= input_t;
  out_imag <= register3_q_net;
  out_real <= register4_q_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  ...
  register3 : entity xil_defaultlib.bram_stn_32bit_xlregister 
  generic map (
    d_width => 32,
  ...
  register4 : entity xil_defaultlib.bram_stn_32bit_xlregister 
  generic map (
    d_width => 32,
    init_value => b"00000000000000000000000000000000"
  )
