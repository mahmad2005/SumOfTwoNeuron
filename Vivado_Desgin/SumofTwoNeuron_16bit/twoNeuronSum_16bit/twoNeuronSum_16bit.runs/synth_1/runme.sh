...
HD_PWD='E:/FPGAProject/01102022/FPGAResearch/5_Final_Submission/Vivado_Desgin/SumofTwoNeuron_16bit/twoNeuronSum_16bit/twoNeuronSum_16bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log twoNeuronSum_16bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source twoNeuronSum_16bit.tcl
